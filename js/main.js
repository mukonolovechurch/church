...
// Set the date we're counting down to
 var countDownDate = new Date("Dec 31, 2023 08:00:00").getTime();
...
// Update the count down every 1 second
 ...
 function onYouTubeIframeAPIReady() {
 	player = new YT.Player('youtubePlayer', {
            videoId: 'kOlfociaqZI', // Replace with your YouTube video ID
            playerVars: {
    ...
    // Function to stop video playback and close the modal
 function stopVideo() {
 	player.stopVideo();
 }
...
// Reset transition after each transition completes
 ...
 history.pushState(null, null, location.pathname.replace(".html", ""));
